...
This documents a real run against 2,000 generated test files (see `demo.py`).
...
[   1/2000] 🖼️ 2024-10-14-product-photo-etsy.psd [Images · 2024-10-14] → Side-Hustle
...
[   4/2000] 🖼️ 2024-10-19-IMG-photoshoot-956.jpg [Images · 2024-10-19] → Client-Photoshoot
...
================================================================
  ...
  ⏱️   Time saved this run: ~16h 40m
      (vs ~16h 40m sorting by hand)
================================================================
```
...
| Sorting 2,000 files by hand | ~16.6 hours |

- **Saved:** ~16.6 hours per 2,000-file batch, ~25 minutes/week ongoing.
